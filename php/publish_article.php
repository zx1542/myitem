...
if($_SERVER['REQUEST_METHOD']=='POST'){
	...
	if($_FILES['upfile']['error']==0){
		...
		$sql="INSERT INTO `h_content`(`title`,`username`,`column`,`description`,`keywords`,`contents`,`thumb`,`add_date`) VALUES('$title','$username','$column','$description','$keywords','$contents','$thumb','$dtime')";
