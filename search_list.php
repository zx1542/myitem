...
$sqlTotal="SELECT * FROM h_content WHERE contents LIKE '%$q%'";
$sql = "SELECT * FROM h_content WHERE contents LIKE '%$q%' LIMIT $pageStart,$pageSize";
...
<div class="container">
    ...
    <ol class="breadcrumb" id="bread">
        ...
        <li class="active">搜索：<?php echo $q;?></li>
    </ol>
	<h2>一共搜索到关于“<span style="color:red;"><?php echo $q;?></span>”<?php echo $totalNum;?>条数据</h2>
    <hr>
    ...
    <div class="row list-pagination">
        <ul class="pagination">
            <li>
                <a  class="<?php if($pages==1){echo 'btn disabled';};?>" href="search_list.php?q=<?php echo $q;?>&page=<?php echo $pages-1;?>" aria-label="Previous">
			...
			for($j=1;$j<=$pageNum;$j++){
			?>
			<li class="<?php if($pages==$j){echo 'active';};?>"><a href=" search_list.php?q=<?php echo $q;?>&page=<?php echo $j;?>"><?php echo $j; ?></a></li>
			<?php		
			}
			?>
            <li>
                <a class="<?php if($pages==$pageNum){echo 'btn disabled';};?>" href="search_list.php?q=<?php echo $q;?>&page=<?php echo $pages+1;?>" aria-label="Next">
