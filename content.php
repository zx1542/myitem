...
<head>
    ...
    <style>
        ...
        footer{width:100%;background:#f5f5f5;border-top:1px solid #ddd;padding:10px 0;margin-top:200px;}
    </style>
...
<div class="container">
    ...
    <ol class="breadcrumb" id="bread">
        ...
        <li><a href="list.php?column=<?php echo $q;?>"><?php echo $q;?></a></li>
        <li class="active"><?php echo $row['title'];?></li>
    </ol>
    <div class="title">
        <h2><?php echo $row['title'];?></h2>
        <p>作者：<span class="btn-info"><?php echo $_SESSION['username'];?></span> 发布日期：<span class="btn-info"><?php echo $row['add_date']; ?></span></p>
    </div>
    <hr>
    <div class="content">
    ...
    <div class="list-group col-md-12">
            <a href="list.php?column=<?php echo $row['column'];?>" target="_blank" class="list-group-item list-group-item-success">
                <span class="glyphicon glyphicon-user"></span>相关文章
            </a>
            <?php
			$sql="SELECT * FROM h_content WHERE `column`='$q'&&`id`!='$id' ORDER BY id DESC";
			$result=$conn->query($sql);
			if($result->num_rows>0){
				while($rows=$result->fetch_assoc()){
			?>
			<a href="content.php?id=<?php echo $row['id'];?>" target="_blank" class="list-group-item"><span class="glyphicon glyphicon-star-empty"></span><?php echo $rows['title'];?></a>		
			<?php		
				};
			};
			?>
